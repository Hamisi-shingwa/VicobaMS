...
<section class="transaction-section">
   <div class="transaction-top-section">
    ...
    <div class="btns">
        <a href="./user_transactions.php"><button class="all">All Account</button></a>
        <a href="./user_transactions.php?type=deposite"><button class="deposite">Deposite</button></a>
        <a href="./user_transactions.php?type=withdraw"><button class="withdraw">Withdraw</button></a>
        <a href="./user_transactions.php?type=credit"><button class="credit">Credit</button></a>
    </div>
   </div>
